...
var TodoApp = (function () {
    ...
    TodoApp.prototype.addTodo = function () {
        if(!this.newTodoText.trim().length && document.querySelector(".new-todo").value.length)
            this.newTodoText=document.querySelector(".new-todo").value;
